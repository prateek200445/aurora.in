        ...
        <div className="footer-grid">
          <div className="footer-column footer-about">
            ...
            <p className="footer-about-desc">
              Designing modern essentials that seamlessly elevate your daily
              life. Consciously crafted, sustainably manufactured, and built to
              endure.
            </p>
          </div>
          ...
          <div className="footer-column footer-links-column">
            ...
            <ul>
              <li>
                <Link to="/returns">Return & Exchange</Link>
              </li>
              <li>
                <Link to="/sustainability">Sustainable Sourcing</Link>
              </li>
            </ul>
          </div>
          <div className="footer-column footer-links-column">
            ...
            <p className="contact-desc">
              Got questions or feedback? Connect with our support team.
            </p>
