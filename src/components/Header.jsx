...
export default function Header({ onCartToggle, onQuickView }) {
  ...
  const isNewArrivalsActive =
    location.pathname === "/shop" && currentFilter === "new";
  const isBestSellersActive =
    location.pathname === "/shop" && currentFilter === "bestseller";
  const isSaleActive =
    location.pathname === "/shop" && currentFilter === "sale";
  const isCategoriesActive =
    location.pathname === "/shop" &&
    (currentCategory || (!currentFilter && !searchParams.get("search")));
    ...
    <header className="site-header">
        ...
        <nav className="site-navigation" aria-label="Main Navigation">
          <ul className="nav-list">
            ...
            <li className="nav-item">
              <Link
                to="/shop?filter=new"
                className={`nav-link ${isNewArrivalsActive ? "active" : ""}`}
            ...
            <li className="nav-item">
              <Link
                ...
                className={`nav-link ${isBestSellersActive ? "active" : ""}`}
                onClick={closeMobileMenu}
              >
                {LABELS.BEST_SELLERS}
              </Link>
            ...
            <li className="nav-item">
              <Link
                to="/shop?filter=sale"
                className={`nav-link text-sale ${isSaleActive ? "active" : ""}`}
                onClick={closeMobileMenu}
              >
      ...
      >
        <div className="mobile-navigation-inner">
          <Link
            to="/shop?filter=new"
            className={`mobile-nav-link ${isNewArrivalsActive ? "active" : ""}`}
            onClick={closeMobileMenu}
          >
            {LABELS.NEW_ARRIVALS}
          </Link>
          <Link
            to="/shop?filter=bestseller"
            className={`mobile-nav-link ${isBestSellersActive ? "active" : ""}`}
            onClick={closeMobileMenu}
          >
            {LABELS.BEST_SELLERS}
          </Link>
          <Link
            to="/shop?filter=sale"
            className={`mobile-nav-link text-sale ${isSaleActive ? "active" : ""}`}
            onClick={closeMobileMenu}
          >
            <span>{LABELS.SALE}</span>
            <Sparkles className="icon-xs sale-icon" />
          ...
          <div className="mobile-nav-group">
            ...
            {["All", "Apparel", "Home Decor", "Skincare", "Electronics"].map(
              (cat) => {
