...
export default function Returns() {
  return (
    <div className="returns-page static-page-container">
      ...
      <h2 className="static-page-heading">Returns</h2>
      <p className="static-page-text">
      ...
      <h2 className="static-page-heading">Exchanges</h2>
      <p className="static-page-text">
      ...
      <h2 className="static-page-heading">Refunds</h2>
      <p className="static-page-text">
